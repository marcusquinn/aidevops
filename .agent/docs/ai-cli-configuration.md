...
**🎯 OBJECTIVE**: Ensure all AI CLI tools automatically read `~/AGENTS.md` and `~/git/ai-assisted-dev-ops/AGENTS.md` at the start of every session for consistent AI agent guidance.
