...
export const text = {
  ...
  approvalExecutionDeferred: "Approval execution is deferred until audited approval tooling exists.",
  devOpsCard: "DevOps card",
  hue: "Hue",
  reset: "Reset",
  ...
  update: "Update",
  tamboGenUiReadOnly: "Tambo GenUI · read-only",
  unsupportedDevOpsCard: "Unsupported DevOps card",
  vault: "Vault",
