...
export const surfaceIds = [
  "overview", "agents", "config", "localSetup", "git", "routines",
  "apps", "installation", "personas", "brands", "domains",
  "registrars", "hosts", "servers", "projects", "security",
] as const;
...
export interface InventorySurfaceDefinition {
...
export const inventorySurfaces: Partial<Record<SurfaceId, InventorySurfaceDefinition>> = {
  brands: {
    title: text.brands,
