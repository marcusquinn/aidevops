...
# =============================================================================
# aidevops Repository Management Library
# =============================================================================
# Repository registration, discovery, and metadata functions extracted from
# aidevops.sh to keep the orchestrator under 2000 lines.
#
# Covers:
#   - repos.json init and migration
#   - Repo registration and slug detection
#   - Mission-control scope resolution
#   - Planning file version checks
#   - Protected branch detection with worktree creation
#
# Usage: source "${_AIDEVOPS_SCRIPT_DIR}/aidevops-repos.sh"
#
# Dependencies:
#   - print_info/success/warning/error (defined in aidevops.sh)
#   - REPOS_FILE, CONFIG_DIR, AGENTS_DIR (set by aidevops.sh)
#   - get_version (defined in aidevops.sh)
#
