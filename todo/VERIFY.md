...
- [ ] v128 t1099 Wire response-scoring to write back to pattern tracker �... | PR #1634 | merged:2026-02-18
...
- [ ] v130 t1081.2 Add --non-interactive support to skill-update-helper.sh �... | PR #1630 | merged:2026-02-18
  files: .agents/scripts/skill-update-helper.sh
  check: shellcheck .agents/scripts/skill-update-helper.sh
  check: file-exists .agents/scripts/skill-update-helper.sh
