...
- Integration point: Claude Code hooks (PostToolUse) or wrapper functions in dispatch
...
- **Domain data sourced from session transcripts** — analyzed 1337+ GitHub hits, 276 x.com hits, and hundreds of other domains from `~/.claude/transcripts/` to build the tiering baseline. Real usage data, not guesswork.
