...
- [x] t100 Add AXe CLI for iOS simulator accessibility automation #tools #ios #testing #accessibility ~10m (ai:8m test:1m read:1m) ref:GH#520 logged:2026-01-30 related:t095,t097 ref:https://github.com/cameroncooke/AXe completed:2026-02-08
  - Notes: Created tools/mobile/axe-cli.md. Covers tap (coords/ID/label), swipe, gesture presets, text input, keyboard control (key/key-sequence/key-combo), hardware buttons, timing controls, screenshots, video recording/streaming, describe-ui. Includes comparison table vs iOS Simulator MCP and XcodeBuildMCP integration workflow. Updated subagent-index.toon with full mobile tool listing.
