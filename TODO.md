...
- [ ] t213 Auto-deploy agents after supervisor merges PRs that modify .agents/scripts/ #bugfix #supervisor #self-improvement ~1h (ai:45m test:15m) logged:2026-02-10
...
- [ ] t214 Email testing suite — design rendering + delivery testing + health check enhancements #plan #email #testing #services → [todo/PLANS.md#2026-02-10-email-testing-suite] ~12h (ai:8h test:3h read:1h) logged:2026-02-10
  - [ ] t214.1 Create services/email/email-design-test.md — local Playwright rendering + Email on Acid API integration ~3h (ai:2h test:45m read:15m)
  ...
  - [ ] t214.2 Create email-design-test-helper.sh — CLI for local + EOA API email design testing ~2h (ai:1h30m test:30m)
  ...
  - [ ] t214.3 Create services/email/email-delivery-test.md — spam filter testing + inbox placement ~2h (ai:1h30m test:20m read:10m)
  ...
  - [ ] t214.4 Create email-delivery-test-helper.sh — CLI for spam testing + inbox placement ~1.5h (ai:1h test:30m)
  ...
  - [ ] t214.5 Enhance email-health-check.md — add content-level checks inspired by EOA Campaign Precheck ~1.5h (ai:1h test:20m read:10m)
  ...
  - [ ] t214.6 Update AGENTS.md, subagent-index.toon, marketing.md cross-references ~30m (ai:20m test:10m)
