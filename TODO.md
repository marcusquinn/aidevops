...
- [x] t017 SEO Machine Integration for aidevops #plan → [todo/PLANS.md#seo-machine-integration-for-aidevops] ~1.5h (ai:45m test:30m read:15m) ref:GH#509 logged:2025-12-21 started:2026-02-08 completed:2026-02-08
...
- [x] t095 Add XcodeBuildMCP for iOS/macOS app testing #tools #mcp #ios #xcode ~15m (ai:10m test:3m read:2m) ref:GH#516 logged:2026-01-30 ref:https://github.com/cameroncooke/XcodeBuildMCP started:2026-02-08 completed:2026-02-08
...
- [x] t096 Add Maestro for mobile and web E2E testing #tools #mobile #testing #e2e ~20m (ai:15m test:3m read:2m) ref:GH#517 logged:2026-01-30 related:t095 ref:https://github.com/mobile-dev-inc/maestro started:2026-02-08 completed:2026-02-08
  - Notes: Maestro (10.6k stars, Apache-2.0) - painless E2E automation for Android, iOS, and web apps. Subagent at tools/mobile/maestro.md with YAML flow syntax, selectors, cross-platform support (Android, iOS, React Native, Flutter, Web), Studio/Cloud integration, and common patterns. Updated subagent-index.toon, browser-automation.md decision tree, and AGENTS.md progressive disclosure table. PR #595.
- [x] t097 Add iOS Simulator MCP for simulator interaction #tools #mcp #ios #testing ~10m (ai:8m test:1m read:1m) ref:GH#518 logged:2026-01-30 related:t095,t096 ref:https://github.com/joshuayoes/ios-simulator-mcp started:2026-02-08 completed:2026-02-08
...
- [x] t100 Add AXe CLI for iOS simulator accessibility automation #tools #ios #testing #accessibility ~10m (ai:8m test:1m read:1m) ref:GH#520 logged:2026-01-30 related:t095,t097 ref:https://github.com/cameroncooke/AXe started:2026-02-08 completed:2026-02-08
...
- [x] t101 Create Mom Test UX/CRO agent framework #agents #ux #cro #conversion ~30m (ai:20m test:5m read:5m) ref:GH#521 logged:2026-01-30 started:2026-02-08 completed:2026-02-08
...
- [x] t124 Add Tirith terminal security guard for homograph/injection attacks #security #tools #terminal ~20m (ai:15m test:3m read:2m) ref:GH#522 logged:2026-02-03 started:2026-02-08T00:00Z ref:https://github.com/sheeki03/tirith completed:2026-02-08
...
- [x] t078 Add Lumen subagent for AI-powered git diffs and commit generation #tools #git #code-review ~10m (ai:8m read:2m) ref:GH#531 logged:2026-01-23 ref:https://github.com/jnsahaj/lumen started:2026-02-08 completed:2026-02-08
...
- [x] t074 Review DocStrange for document structured data extraction #research #tools #document-extraction ~10m (ai:8m read:2m) ref:GH#532 logged:2026-01-25 ref:https://github.com/NanoNets/docstrange started:2026-02-08 completed:2026-02-08
...
- [x] t075 Content Calendar Workflow subagent #content #seo #planning ~20m (ai:15m test:5m) ref:GH#533 logged:2026-01-25 ref:t037 completed:2026-02-08
  - Notes: Inspired by ALwrity (see todo/research/alwrity-review.md). Create tools/content/content-calendar.md subagent. Features: AI-powered content gap analysis, topic suggestions based on keyword research, scheduling across platforms, content lifecycle tracking. Integrate with keyword-research.md and google-search-console.md. BLOCKED: Max retries exceeded: clean_exit_no_signal
- [ ] t076 Platform Persona Adaptations for content guidelines #content #marketing ~15m (ai:10m test:5m) ref:GH#534 logged:2026-01-25 ref:t037
  - Notes: Inspired by ALwrity persona system. Extend content/guidelines.md with platform-specific sections for LinkedIn, Instagram, YouTube. Define voice, tone, structure, and best practices per platform. BLOCKED: Max retries exceeded: clean_exit_no_signal
