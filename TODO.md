...
- [ ] t212 Fix issue-sync status labels: status:available on assign, status:done on close #bugfix #sync ~30m (ai:20m test:10m) started:2026-02-10 logged:2026-02-10
