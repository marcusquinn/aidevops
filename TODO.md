...
- [ ] t215 Accessibility & contrast testing — WCAG compliance for websites + emails #plan #accessibility #testing #wcag → [todo/PLANS.md#2026-02-10-accessibility-contrast-testing] ~2.5h (ai:2h test:25m read:5m) logged:2026-02-10
  - [ ] t215.1 Create services/accessibility/accessibility-audit.md — unified web + email accessibility agent ~15m
  ...
  - [ ] t215.2 Create accessibility-audit-helper.sh — CLI wrapping axe-core, WAVE, WebAIM contrast, Lighthouse a11y ~25m
  ...
  - [ ] t215.3 Playwright contrast extraction — computed style analysis for all visible elements ~20m
  ...
  - [ ] t215.4 WAVE API integration — comprehensive accessibility analysis ~15m
  ...
  - [ ] t215.5 Enhance pagespeed.md — surface Lighthouse accessibility as first-class output ~15m
  ...
  - [ ] t215.6 Email accessibility checks — integrate into email-health-check + email-design-test ~15m
  ...
  - [ ] t215.7 Update AGENTS.md, subagent-index.toon, cross-references ~10m
...
- [ ] t216 Orphaned PR scanner — run eagerly after worker evaluation, not just Phase 6 throttled #bugfix #supervisor #self-improvement ~1.5h (ai:1h test:30m) logged:2026-02-10
...
- [ ] t217 Worker prompt — enforce Task tool parallelism for independent subtasks #enhancement #supervisor #efficiency ~1h (ai:45m test:15m) logged:2026-02-10
...
- [ ] t218 Verification proof-logs — structured audit trail for task completion trust #enhancement #supervisor #verification ~2h (ai:1.5h test:30m) logged:2026-02-10
...
- [ ] t219 PR lifecycle — faster merge pipeline with parallel CI + review triage #enhancement #supervisor #throughput ~1.5h (ai:1h test:30m) logged:2026-02-10
