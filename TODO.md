...
- [x] t158 Fix supervisor dispatch so dynamically-created tasks work with /full-loop #bugfix #supervisor #orchestration ~1h (ai:45m test:15m) ref:GH#573 logged:2026-02-08 started:2026-02-08 completed:2026-02-08
  - Notes: Already implemented. build_dispatch_cmd passes task description inline in the prompt (` -- description`), full-loop.md Step 0 has 3-tier resolution: inline desc > TODO.md > supervisor DB, full-loop-helper.sh PR creation queries supervisor DB as fallback.
- [x] t160 fix: supervisor TODO.md push fails under concurrent workers, add reconcile-todo command #bugfix #supervisor ~1h (ai:45m test:15m) ref:GH#579 logged:2026-02-08 started:2026-02-08 completed:2026-02-08
  - Notes: Already implemented. commit_and_push_todo() has pull-rebase retry logic (3 attempts with backoff). cmd_reconcile_todo() exists for bulk reconciliation. Reconcile wired into pulse cycle Phase 7.
- [x] t162 fix: supervisor DB safety - add backup-before-migrate and explicit column migrations #bugfix #supervisor ~30m (ai:25m test:5m) ref:GH#590 logged:2026-02-08 started:2026-02-08 completed:2026-02-08
  - Notes: Fixed t128.8 migration to dynamically detect existing columns (issue_url, diagnostic_of, triage_result) and include them in INSERT to prevent data loss. New table schema includes all columns upfront. Added backup_db() call before ALTER TABLE migration group. backup_db/restore_db already existed for destructive migrations.
...
- [x] t131 gopass Integration & Credentials Rename #plan #security #credentials → [todo/PLANS.md#2026-02-06-gopass-integration--credentials-rename] ~2d (ai:1d test:4h read:4h) logged:2026-02-06 ref:todo/tasks/prd-gopass-credentials.md completed:2026-02-08
...
- [x] t128 Autonomous Supervisor Loop #plan #orchestration #runners → [todo/PLANS.md#2026-02-06-autonomous-supervisor-loop] ~8h (ai:5h test:2h read:1h) logged:2026-02-06 ref:todo/tasks/prd-autonomous-supervisor.md completed:2026-02-08
...
- [x] t071 Voice AI models for speech generation and transcription #tools #voice #ai ~30m (ai:20m test:5m read:5m) ref:GH#502 logged:2026-01-24 related:t027 completed:2026-02-08
...
- [x] t072 Audio/Video Transcription subagent #tools #voice #transcription #ai ~1.5h (ai:45m test:30m read:15m) ref:GH#503 logged:2026-01-24 related:t071,t027 completed:2026-02-08
...
- [x] t073 Document Extraction Subagent & Workflow #plan → [todo/PLANS.md#2026-01-25-document-extraction-subagent--workflow] ~1h (ai:30m test:20m read:10m) ref:GH#504 logged:2026-01-25 completed:2026-02-08
  - [x] t073.1 Implementation (all subagents + scripts) ~30m completed:2026-02-08
  - [ ] t073.2 Integration Testing ~30m
  - Notes: Created document-extraction-helper.sh (extract, parse, pii-scan, batch, status, install commands). Supports Docling+ExtractThinker+Presidio pipeline and DocStrange alternative. Privacy modes: local/edge/cloud/none. Subagent at tools/document/document-extraction.md (201 lines), DocStrange at tools/content/docstrange.md (122 lines).
...
- [x] t012 OCR Invoice/Receipt Extraction Pipeline #plan → [todo/PLANS.md#ocr-invoicereceipt-extraction-pipeline] ~3h (ai:1.5h test:1h read:30m) ref:GH#506 logged:2025-12-21 completed:2026-02-08
  - Notes: Covered by document-extraction-helper.sh + document-extraction.md. Invoice/Receipt extraction schemas defined in subagent. DocStrange also supports invoice extraction natively. Use: `document-extraction-helper.sh extract invoice.pdf --fields "vendor,total,date,items"`
...
- [x] t017 SEO Machine Integration for aidevops #plan → [todo/PLANS.md#seo-machine-integration-for-aidevops] ~1.5h (ai:45m test:30m read:15m) ref:GH#509 logged:2025-12-21 completed:2026-02-08
  - Notes: Created seo/seo-content-workflow.md subagent. Covers 5-step content pipeline (research/write/optimize/analyze/rewrite), readability scoring, keyword density, SEO quality score (0-100), search intent classification, context system. Python analysis modules deferred to Phase 1 of PLANS.md.
...
- [x] t095 Add XcodeBuildMCP for iOS/macOS app testing #tools #mcp #ios #xcode ~15m (ai:10m test:3m read:2m) ref:GH#516 logged:2026-01-30 ref:https://github.com/cameroncooke/XcodeBuildMCP completed:2026-02-08
  - Notes: MCP server for Xcode integration with AI assistants (4.1k stars, MIT). Subagent at tools/mobile/xcodebuild-mcp.md with 76 tools across 15 workflow groups (simulator, device, macOS, SPM, debugging, UI automation, logging, project discovery/scaffolding, session management). Updated subagent-index.toon and AGENTS.md progressive disclosure table with mobile domain entry.
- [x] t096 Add Maestro for mobile and web E2E testing #tools #mobile #testing #e2e ~20m (ai:15m test:3m read:2m) ref:GH#517 logged:2026-01-30 related:t095 ref:https://github.com/mobile-dev-inc/maestro completed:2026-02-08
...
- [x] t097 Add iOS Simulator MCP for simulator interaction #tools #mcp #ios #testing ~10m (ai:8m test:1m read:1m) ref:GH#518 logged:2026-01-30 related:t095,t096 ref:https://github.com/joshuayoes/ios-simulator-mcp completed:2026-02-08
...
- [x] t098 Add Playwright device emulation subagent #tools #browser #testing #mobile ~10m (ai:8m test:1m read:1m) ref:GH#519 logged:2026-01-30 started:2026-02-06T00:00Z related:t096 ref:https://playwright.dev/docs/emulation completed:2026-02-08
...
- [x] t100 Add AXe CLI for iOS simulator accessibility automation #tools #ios #testing #accessibility ~10m (ai:8m test:1m read:1m) ref:GH#520 logged:2026-01-30 related:t095,t097 ref:https://github.com/cameroncooke/AXe completed:2026-02-08
...
- [x] t101 Create Mom Test UX/CRO agent framework #agents #ux #cro #conversion ~30m (ai:20m test:5m read:5m) ref:GH#521 logged:2026-01-30 completed:2026-02-08
...
- [x] t124 Add Tirith terminal security guard for homograph/injection attacks #security #tools #terminal ~20m (ai:15m test:3m read:2m) ref:GH#522 logged:2026-02-03 ref:https://github.com/sheeki03/tirith completed:2026-02-08
...
- [x] t109 Parallel Agents & Headless Dispatch #plan → [todo/PLANS.md#2026-02-03-parallel-agents--headless-dispatch] ~3d (ai:1.5d test:1d read:0.5d) ref:GH#523 logged:2026-02-03 started:2026-02-05T00:00Z completed:2026-02-08
...
- [x] t112 VoiceInk to OpenCode via macOS Shortcut #tools #voice #automation ~15m (ai:10m test:5m) ref:GH#525 logged:2026-02-04 started:2026-02-08T00:00Z related:t080,t081 completed:2026-02-08
  - Notes: Created tools/voice/voiceink-shortcut.md (266 lines). Covers macOS Shortcut setup, VoiceInk transcription flow, HTTP POST to OpenCode server API, AppleScript instructions.
...
- [x] t114 Pipecat STS integration with OpenCode #tools #voice #ai ~30m (ai:20m test:5m read:5m) ref:GH#527 logged:2026-02-04 started:2026-02-08 related:t080,t081 completed:2026-02-08
  - Notes: Created tools/voice/pipecat-opencode.md (456 lines). Covers Pipecat pipeline setup, Soniox STT + Cartesia TTS + OpenCode API integration, real-time voice conversation.
...
- [x] t120 Review @thymikee post for aidevops inclusion #research #tools ~5m (ai:4m read:1m) ref:GH#529 logged:2026-02-05 ref:https://x.com/thymikee/status/2018786174152970422 completed:2026-02-08
  - Notes: Reviewed. agent-device by Callstack (Michal Pierzchala) - unified iOS+Android automation CLI for AI agents. Token-efficient accessibility tree snapshots, session management, element refs. DEFER: v0.2.4, 6 days old, no public GitHub repo yet, API unstable (15 releases in 6 days). Re-evaluate in 4-6 weeks.
...
- [x] t078 Add Lumen subagent for AI-powered git diffs and commit generation #tools #git #code-review ~10m (ai:8m read:2m) ref:GH#531 logged:2026-01-23 ref:https://github.com/jnsahaj/lumen completed:2026-02-08
...
- [x] t074 Review DocStrange for document structured data extraction #research #tools #document-extraction ~10m (ai:8m read:2m) ref:GH#532 logged:2026-01-25 ref:https://github.com/NanoNets/docstrange completed:2026-02-08
...
- [x] t075 Content Calendar Workflow subagent #content #seo #planning ~20m (ai:15m test:5m) ref:GH#533 logged:2026-01-25 ref:t037 completed:2026-02-08
...
- [x] t076 Platform Persona Adaptations for content guidelines #content #marketing ~15m (ai:10m test:5m) ref:GH#534 logged:2026-01-25 ref:t037 completed:2026-02-08
...
- [x] t077 LinkedIn Content Subagent #tools #social-media ~10m (ai:8m test:2m) ref:GH#535 logged:2026-01-25 ref:t037 completed:2026-02-08
...
- [ ] t131 Create tools/vision/ category for visual AI models #tools #vision #ai ~30m (ai:20m test:5m read:5m) ref:GH#538 logged:2026-02-06 related:t080
