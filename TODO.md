...
- [x] t096 Add Maestro for mobile and web E2E testing #tools #mobile #testing #e2e ~20m (ai:15m test:3m read:2m) ref:GH#517 logged:2026-01-30 related:t095 ref:https://github.com/mobile-dev-inc/maestro started:2026-02-08 completed:2026-02-08
  - Notes: Maestro subagent (tools/mobile/maestro.md) created with YAML flow syntax, core commands, selectors, cross-platform support (Android/iOS/web/React Native/Flutter), Maestro Studio/Cloud docs, common patterns, and integration with aidevops tools (MiniSim, XcodeBuildMCP, iOS Simulator MCP, Playwright Emulation, AXe CLI). Added setup_maestro() to setup.sh with Java 17+ check and verified_install(). Cross-references added to browser-automation.md, playwright-emulation.md, xcodebuild-mcp.md, ios-simulator-mcp.md, axe-cli.md. Listed in subagent-index.toon and AGENTS.md progressive disclosure table.
