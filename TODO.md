...
- [ ] t200 Evaluate and import Veo 3 Meta Framework as aidevops skill #feature #content #video ~30m (ai:20m test:10m) logged:2026-02-09 blocked-by:t199 related:t199.5
...
- [ ] t201 Transcript corpus ingestion for channel competitive intel #feature #content #youtube ~2h (ai:1.5h test:30m) logged:2026-02-09 blocked-by:t199 related:t199.1
...
- [ ] t202 Seed bracketing automation for AI video generation #feature #content #video ~2h (ai:1.5h test:30m) logged:2026-02-09 blocked-by:t199 related:t199.5
...
- [ ] t203 AI video generation API helpers (Sora 2 / Veo 3.1 / Nanobanana Pro) #feature #content #video #image ~4h (ai:3h test:1h) logged:2026-02-09 blocked-by:t199
...
- [ ] t204 Voice pipeline helper — CapCut cleanup + ElevenLabs transformation chain #feature #content #audio ~1.5h (ai:1h test:30m) logged:2026-02-09 blocked-by:t199 related:t199.6
...
- [ ] t195 Supervisor evaluate_worker PR validation — verify PR title/branch contains task ID before attributing #bugfix #supervisor ~1h (ai:45m test:15m) ref:GH#814 assignee:marcusquinn started:2026-02-09T22:46:42Z logged:2026-02-09
...
- [x] t200 Fix SC2012 in review-pulse-helper.sh — replace `ls` with `find`/`fd` for file discovery #quality #shell ~15m (ai:10m test:5m) logged:2026-02-09 completed:2026-02-09 verified:2026-02-09 PR #818 merged
...
- [ ] t201 Add AGENTS.md rule: re-verify task ID after git pull --rebase before push #docs #workflow #quality ~15m (ai:10m) logged:2026-02-09
  - Notes: Race condition hit twice in one session — parallel sessions created t195 and t196 simultaneously, causing duplicate IDs in TODO.md. Root cause: agent assigns next ID, commits, push fails, does pull --rebase, pushes again WITHOUT re-checking if the ID is still free. Fix: add rule to AGENTS.md Planning & Tasks section and full-loop.md that after any `git pull --rebase` on TODO.md, the agent MUST re-read the file and verify the assigned task ID is still unique. If collision detected, renumber before pushing. Cheap instruction-level fix that prevents the most common case.
