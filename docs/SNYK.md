...
./providers/snyk-helper.sh install
...
./providers/snyk-helper.sh status

# Scan current directory for dependency vulnerabilities
./providers/snyk-helper.sh test

# Scan source code for security issues
./providers/snyk-helper.sh code

# Scan a container image
./providers/snyk-helper.sh container nginx:latest

# Scan Infrastructure as Code files
./providers/snyk-helper.sh iac ./terraform/

# Run all security scans
./providers/snyk-helper.sh full
```
...
./providers/snyk-helper.sh test . my-org

# Scan with JSON output for CI/CD
./providers/snyk-helper.sh test . "" "--json"

# Scan with severity threshold
./providers/snyk-helper.sh test . "" "--severity-threshold=critical"

# Scan all projects in a monorepo
./providers/snyk-helper.sh test . "" "--all-projects"

# Scan container with Dockerfile context
./providers/snyk-helper.sh container my-image:tag "" "--file=Dockerfile"
```
...
./providers/snyk-helper.sh monitor . my-org my-project-name
...
./providers/snyk-helper.sh sbom . cyclonedx1.4+json sbom.json

# Generate SPDX SBOM
./providers/snyk-helper.sh sbom . spdx2.3+json sbom-spdx.json
```
...
./providers/snyk-helper.sh accounts
