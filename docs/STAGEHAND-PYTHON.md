...
# Or step by step
bash providers/stagehand-python-helper.sh install
...
bash providers/stagehand-python-helper.sh install      # Install Stagehand Python
bash providers/stagehand-python-helper.sh setup       # Complete setup
bash providers/stagehand-python-helper.sh status      # Check installation

# Virtual environment management
bash providers/stagehand-python-helper.sh activate    # Show activation command
...
# Maintenance
bash providers/stagehand-python-helper.sh clean       # Clean cache and logs
```
