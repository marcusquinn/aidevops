...
./providers/dns-helper.sh create-record personal local.yourdomain.com CNAME yourdomain.com

# Manage staging environments
./providers/dns-helper.sh create-record business staging.company.com A 10.0.1.50
```
