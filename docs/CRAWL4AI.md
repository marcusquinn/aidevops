...
./providers/crawl4ai-helper.sh extract https://research-paper.com '{
  "title": "h1",
  "authors": ".authors",
  "abstract": ".abstract", 
  "sections": {
...
./providers/crawl4ai-helper.sh extract https://ecommerce.com/product '{
...
1. **Install and Setup**: Run `./providers/crawl4ai-helper.sh install`
2. **Start Docker Services**: Run `./providers/crawl4ai-helper.sh docker-start`
...
5. **Setup MCP**: Run `./providers/crawl4ai-helper.sh mcp-setup`
