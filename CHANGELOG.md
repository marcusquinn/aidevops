...
- Maintenance: mark t18464 complete (pr:#32154 completed:2026-09-20) (#32151)

### Fixed

- harden pulse failure accounting
...
- repair stale NVM launcher during CLI convergence
...
- add private offline evaluation journal (#32051)

### Fixed

- recover stale runtime deployment fence (#32052)
...
- prevent overdue Pulse routines from starving
...
- converge Dependabot PR lifecycle
...
- restore live readiness and merge recovery

## [3.32.354] - 2026-09-10

### Fixed

- conclude completed parent trackers
...
- keep Pulse discovery and PR verification productive
- enforce qlty regression quality gate
...
- preserve locked approval diagnostics (#31575)
...
- use available GitHub quota with adaptive admission
...
- admit unchanged dispatch targets from lagging mirrors
...
- preserve quota blockers in Pulse cycle health
...
- Fix worker token expiry across runner timezones

## [3.32.318] - 2026-09-06

### Changed

- Documentation: Aggregate verified productivity release sources
- Refactor: Remove productivity recovery complexity regressions

### Fixed

- Keep Search quota exhaustion from freezing unrelated work
- Restore Pulse productivity and bounded REST recovery
- reconcile terminal full-loop status
- route Playwriter through scoped agent

## [3.32.317] - 2026-09-05

### Added

- Integrate pinned video-use runtime and render verification
- Add opt-in Blender Lab MCP support

### Changed

- Maintenance: refresh complete aggregation after #31336
- Documentation: prepare v3.32.317 release notes
- Refactor: simplify GitHub transport governor (GH#31324) (#31330)
- Tests: align worker-detection launch fixtures (#31318)
- Documentation: brief compounding-value architecture and execution roadmap
- Documentation: Document optional webhooks and contextual OS selection
- Refactor: simplify failed launch recovery recording

### Fixed

- fix secret inventory cleanup lifetime
- exclude runtime state from full-loop staging
- Verify successor ref absence before creation
- Normalize reserved intent for release successors
- propagate interactive claim failures (#31319)
- Preserve API deferral through full-loop verification
- Align hero and README with callable module inventory
- stabilize Qlty scan consensus (#31284)
- fix initial-model preference fallback
- Reject stale release aggregation merge bases

## [3.32.316] - 2026-09-05

### Fixed

- fix Codacy A-grade monitoring and maintenance safeguards
...
- Documentation: Aggregate standard-tier release provenance
...
- Generate daily total contribution profile charts
- default thinking to Astra low with reasoning escalation

### Changed

- Documentation: aggregate authorized Astra thinking release
- Performance: Default routine releases to standard-tier execution
- Maintenance: mark t18401 complete (pr:#31200 completed:2026-09-05) (#31206)

### Fixed

- preserve TODO-sync trash recovery (#31217)
- Fix worktree fixture leaks and PR archive attribution
...
- recognize protected release merge trees
...
- separate update from source access privilege
...
- Documentation: stage v3.32.284 release aggregation

### Fixed

- explain cross-runner CI repair routing (#30539)
...
- Documentation: clarify approval versus dispatch readiness

### Fixed

- Fix annotated release tag parsing
...
- trust Vite React Dependabot update (#30424)
- retain supported file-type runtime (#30422)
- trust Elysia Dependabot update (#30420)
- trust Vite Dependabot review gates (#30418)
- trust reviewed Actions Dependabot updates (#30391)
...
- recover reserved release lanes after aggregation (#29930)
...
- enforce stats wrapper timeout (#29837)
...
- auto-dispatch trusted quality audit findings
- serialize repository release lanes (#29797)

## [3.32.237] - 2026-08-08

### Fixed

- coalesce redundant dispatch lease renewal comments
- refresh existing routine schedule metadata (#29789)
...
- Maintenance: bump react and @types/react

### Fixed

- Restore strict broad-ratchet schema compatibility
- verify live Dependabot Bot identity
- Fix metadata-sensitive absolute Qlty scans
- accept quoted Dependabot dependency names
...
- define isolated app-team manifests (#29510)
...
- regenerate config after incremental deploy (#27573)
...
- return success after command generation (#27569)
...
- Maintenance: sync ref:GH#27564 to TODO.md [skip ci]
- Maintenance: sync ref:GH#27560 to TODO.md [skip ci]
- Tests: short-circuit absent fixture git (#27553)

### Fixed

- scope postflight to release-owned checks (#27559)

## [3.32.101] - 2026-07-13

### Fixed

- skip jq for empty approval reviews (#27532)

## [3.32.100] - 2026-07-13

### Changed

- Maintenance: sync ref:GH#27529 to TODO.md [skip ci]
...
- Performance: reduce issue mapping jq processes (#27512)

## [3.32.96] - 2026-07-13

### Fixed

- make manual dispatch guidance tier-based (#27511)
...
- run releases from detached worktree (#27496)
...
- Maintenance: sync ref:GH#27487 to TODO.md [skip ci]
- Maintenance: update simplification state registry
- Maintenance: update simplification state registry
...
- select one coordinator artifact across pages (#27475)
...
- Documentation: harden issue approval reviews (#27468)
...
- Maintenance: sync ref:GH#27452 to TODO.md [skip ci]

### Fixed

- guard recurrent file-size debt reconciliation (#27451)
...
- Maintenance: sync ref:GH#27338 to TODO.md [skip ci]
- Maintenance: sync ref:GH#27335 to TODO.md [skip ci]
...
- keep ripgrep current across supported platforms (#27331)
...
- advance dependency-blocked roadmaps (#27327)
...
- let initial tasks call tools before greeting (#27316)

## [3.32.48] - 2026-07-12

### Added

- unify observation scope and deduplication (#27318)
- add resumable session observation proposals (#27317)
...
- preserve divergent canonical tip during recovery (#27313)
...
- Optimise local linter CPU usage (#27062)

## [3.32.19] - 2026-07-11

### Added

- canonicalize workload model tiers (#27060)

## [3.32.18] - 2026-07-11

### Changed

- Maintenance: sync ref:GH#27057 to TODO.md [skip ci]
- Maintenance: sync ref:GH#27056 to TODO.md [skip ci]

### Fixed

- install durable aidevops CLI entrypoint (#27058)
...
- Maintenance: sync ref:GH#27045 to TODO.md [skip ci]
- Keep OpenCode diagnostics out of the TUI (#27043)
...
- Keep canonical guard setup compatible (#27019)

## [3.32.10] - 2026-07-11

### Fixed

- block canonical branch mutations (#27015)
...
- Documentation: prepare 3.32.4 changelog
- make quality gates resource-aware (#26877)
- Maintenance: update simplification state registry
...
- restore sudo gh auth recovery (#26751)

## [3.31.79] - 2026-07-07

### Fixed

- fail new task when tracker creation fails
...
- show AI provider metadata while vault locked (#26731)

## [3.31.75] - 2026-07-06

### Changed

- feat: improve AI providers UI (#26728)
...
- hold dirty worker redispatch and checkpoint briefs (#26668)
...
- update green behind PR branches without auto-merge (#26664)
...
- recover commit-and-pr rebase failures (#26629)

## [3.31.60] - 2026-07-05

### Changed

- fix worktree cleanup lifecycle (#26625)
- Maintenance: sync ref:GH#26622 to TODO.md [skip ci]
...
- handle review-feedback false positives (#26615)

### Fixed

- read deployed routines helper version (#26617)
...
- add routines health check command (#26614)

## [3.31.55] - 2026-07-05

### Changed

- Maintenance: tidy 3.31.54 changelog
...
- centralise known bots list so workflow stays current via aidevops update (#17971)
