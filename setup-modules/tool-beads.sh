...
# Beads task-graph tool installation and Claude Code safety hooks setup.
...
_install_bv_tool() {
	...
	# shellcheck disable=SC2154  # install_viewer is set by setup_prompt nameref
	...
	if command -v brew &>/dev/null; then
		...
		# shellcheck disable=SC2154  # use_script is set by setup_prompt nameref
...
_install_beads_node_tools() {
	...
	# shellcheck disable=SC2154  # install_web is set by setup_prompt nameref
	...
	# shellcheck disable=SC2154  # install_bdui is set by setup_prompt nameref
...
_install_perles() {
	...
	# shellcheck disable=SC2154  # install_perles is set by setup_prompt nameref
...
setup_beads_ui() {
	...
	# shellcheck disable=SC2154  # install_beads_ui is set by setup_prompt nameref
