...
# Agent deployment: deploy_aidevops_agents, deploy_ai_templates, inject_agents_reference, config injection.
# Runtime agent conversion: agent-runtime.sh. Beads + safety hooks: tool-beads.sh.
# Part of aidevops setup.sh modularization (t316.3, t1940).
