...
| 53 | PR #24063 | pre-existing drift on main — 51 smells vs threshold 45 on the absolute Qlty Smell Threshold job; PR #24063 changes shell, Markdown, and JSON Nostr VPN guidance, while the CI offender list points at existing Python helpers and OpenCode plugin files outside the PR scope. Pure drift absorption; 51 actual + 2 buffer = 53. |
| 52 | ratchet-post-merge | auto-ratchet after 7e30c72 ("Add Nostr VPN macOS source build guidance (#24063)"): count 50 + 2 buffer = 52 (previously 53, reduction 1) |
