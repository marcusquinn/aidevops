...
| 54 | GH#26346/PR #26358 | shell-only pulse-canonical-recovery function extraction leaves the changed file with zero qlty smells, while the absolute-count Qlty Smell Threshold job reports 52 smells vs threshold 51 on the PR merge ref. 52 actual + 2 buffer = 54; ratchet back down after smell-reducing merges. |
