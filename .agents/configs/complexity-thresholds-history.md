...
| 42 | GH#22481/t3515 (PR #22494) | pre-existing drift on main — 40 smells vs threshold 39; local SARIF shows no qlty findings in changed pulse prefetch/current-state files, and the PR's Qlty Maintainability Smells/qlty check jobs pass; pure drift absorption; 40 actual + 2 buffer = 42; ratchet-post-merge.yml will reset toward actual after the next smell-reducing merge |
