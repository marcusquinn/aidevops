...
| 3D Modelling/CAD | 3D modelling, modeling, Blender, FreeCAD, CAD, blend file, Geometry Nodes, LiDAR, splats, configurable product, exploded parts, sections, elevations | `3d-modelling.md`, `tools/design/3d-workflows.md`, `tools/design/blender.md`, `tools/design/freecad.md`, `tools/design/3d-capture.md` |
