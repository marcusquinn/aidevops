...
| Content | blog, article, script, social, X/Twitter, xurl, newsletter, multi-channel content | `content.md`, `content/social-xurl.md` |
| Video | video, editing, DaVinci Resolve, timeline, grading, compositing, footage | `video.md`, `workflows/creative-production.md`, `tools/video/davinci-resolve.md` |
| Audio/Music/Voice | audio, music, Ableton, MIDI, stems, mixing, mastering, voice | `audio.md`, `workflows/creative-production.md`, `tools/audio/ableton.md`, `tools/voice/speech-to-speech.md`, `tools/voice/transcription.md` |
...
| Design | UI, UX, brand, visual, inspiration, design system, distinctive UI, anti-slop, Hallmark, Taste Skill, design audit, redesign, brand concept board, image-to-code, mobile journey, Affinity Studio, Affinity artwork, logo, icon, brand assets | `tools/design/design-md.md`, `tools/design/distinctive-ui.md`, `tools/design/ui-ux-inspiration.md`, `tools/design/ui-ux-catalogue.toon`, `tools/design/brand-identity.md`, `tools/design/brand-concepts.md`, `tools/design/visual-concepts.md`, `tools/design/affinity.md` |
| 3D Modelling/CAD | 3D modelling, modeling, Blender, FreeCAD, OpenSCAD, SCAD, CAD, blend file, Geometry Nodes, LiDAR, splats, configurable product, exploded parts, sections, elevations | `3d-modelling.md`, `tools/design/3d-workflows.md`, `tools/design/blender.md`, `tools/design/freecad.md`, `tools/design/openscad.md`, `tools/design/3d-capture.md` |
...
| External data APIs | GetAnyAPI, AnyAPI, scraping API, data marketplace, normalized platform data, paid data fallback | `tools/data-extraction/getanyapi.md`, `tools/data-extraction/outscraper.md`, `seo/dataforseo.md`, `tools/browser/browser-automation.md` |
