...
| Shopify | `configs/mcp-templates/shopify-dev-mcp-config.json.txt` — set `platform:shopify` in repos.json to auto-enable Shopify Dev MCP (GraphQL, Liquid validation, Admin API). Requires Shopify CLI 3.93.0+. |
