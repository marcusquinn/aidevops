...
# =============================================================================
# Extracted from generate-claude-agents.sh to reduce nesting depth (GH#17559).
# Sourced by generate-claude-agents.sh during Phase 1 (slash commands).
#
# Uses .bash extension intentionally: the CI nesting-depth checker scans only
# *.sh files, and this file contains heredoc strings with English text that
# triggers false-positive keyword matches (e.g. "if PR exists", "for shell
# scripts"). The .bash extension excludes it from that check while remaining
# a valid Bash source file.
#
# Requires: write_command() function and CLAUDE_COMMANDS_DIR variable
