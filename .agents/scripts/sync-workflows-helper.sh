...
EOF
	...
	# gh_create_pr auto-injects signature footer and handles rate-limit routing.
	# If the wrapper is missing, we fail explicitly — this script MUST run
	# inside an aidevops install.
