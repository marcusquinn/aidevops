...
# =============================================================================
# Full-Loop Lifecycle State -- persistence, phase emission, gates, and commands
# =============================================================================
# Focused sub-library for full-loop-helper-state.sh: lifecycle persistence,
# phase emitters, gate checks, and start/resume/status/cancel/logs/complete.
# Usage: source "${SCRIPT_DIR}/full-loop-helper-state-lifecycle.sh"
# Dependencies:
