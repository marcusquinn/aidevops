...
test_render_markdown_fixture() {
	...
	assert_contains "$_out" "badge-prefix" "Markdown render includes mini evidence badge prefix"
...
test_render_json_fixture() {
	...
	assert_contains "$_out" "badge-prefix" "JSON render includes mini evidence badge prefix"
