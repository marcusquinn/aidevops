...
run_exact_attempt_test() (
	...
	local state='{"schema_version":1,"repository":"test/repo","active":true,"source_pr":90,"phase":"exact-tag-deployment","tag":"v1.2.3","operation_token":"token","terminal_receipt":null}'
	...
	release_lane_defer_stale_runtime_recovery test/repo 90 v1.2.3 "$head" || return 1
...
run_refusal_test() (
	...
	if release_lane_defer_stale_runtime_recovery test/repo 90 v1.2.3 '2222222222222222222222222222222222222222'; then return 1; fi
	[[ "$writes" -eq 0 ]]
)
