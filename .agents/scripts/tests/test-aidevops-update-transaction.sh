...
printf 'manifest helper\n' >"$VERIFY_FIXTURE_REPO/.agents/scripts/runtime-bundle-manifest.sh"
...
cp "$VERIFY_FIXTURE_REPO/.agents/scripts/runtime-bundle-manifest.sh" "$VERIFY_NEW_ROOT/scripts/runtime-bundle-manifest.sh"
