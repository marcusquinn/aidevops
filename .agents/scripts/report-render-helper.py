...
.source-card-link { display: inline-flex; width: 1.6rem; height: 1.6rem; align-items: center; justify-content: center; margin-left: .5rem; border: 1px solid var(--report-line); border-radius: var(--report-badge-radius); color: var(--report-blue); text-decoration: none; vertical-align: middle; }
.source-card-link::before { content: "↗"; font-weight: 900; }
