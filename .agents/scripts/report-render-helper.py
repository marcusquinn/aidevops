...
.code-block-wrap, .mermaid-rendered, .latex-rendered-block { max-width: 100%; min-width: 0; margin: 1rem 0; border: 1px solid var(--report-line); border-radius: 10px; overflow: hidden; background-clip: padding-box; background: var(--report-code-bg); color: var(--report-code-ink); }
