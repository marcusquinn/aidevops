...
cmd_test() {
	...
	_test_expect "URL with &token= param" 2 "https://api.example.com/callback?id=1&token=sk_live_abcdef123456"
	_test_expect "URL with ?api_key= param" 2 "https://hooks.example.com/v1?api_key=AKIAIOSFODNN7EXAMPLE"
