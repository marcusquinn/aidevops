...
# =============================================================================
# localdev-init-lib.sh -- Init and Traefik setup functions
# =============================================================================
# One-time system setup: dnsmasq, /etc/resolver/local, Traefik conf.d migration,
# mkcert installation, docker-compose, and project name inference.
#
# Usage: source "${SCRIPT_DIR}/localdev-init-lib.sh"
#
# Dependencies:
#   - shared-constants.sh (print_error, print_info, etc.)
#   - localdev-helper.sh exports: SCRIPT_DIR, LOCALDEV_DIR, CONFD_DIR,
#     TRAEFIK_STATIC, DOCKER_COMPOSE, BACKUP_DIR
#   - detect_brew_prefix() must be defined by the caller (localdev-helper.sh)
#
