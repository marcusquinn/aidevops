...
# =============================================================================
# Self-Evolution Core -- Database utilities, schema, and shared helpers
# =============================================================================
# Provides the foundational database layer for the self-evolution system:
# SQLite wrappers, SQL escaping, gap ID generation, schema initialization,
# and time utilities.
#
# Usage: source "${SCRIPT_DIR}/self-evolution-helper-core.sh"
#
# Dependencies:
#   - shared-constants.sh (print_error, print_info, log_*, backup_sqlite_db)
#   - sqlite3
#
...
# Include guard
[[ -n "${_SELF_EVOL_CORE_LIB_LOADED:-}" ]] && return 0
_SELF_EVOL_CORE_LIB_LOADED=1
...
# Uses same base as entity-helper.sh
