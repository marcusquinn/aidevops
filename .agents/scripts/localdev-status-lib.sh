...
# =============================================================================
# localdev-status-lib.sh -- Status dashboard and list command functions
# =============================================================================
# Provides the status and list commands including cert status checks,
# port health monitoring, LocalWP site reading, and formatted output.
#
# Usage: source "${SCRIPT_DIR}/localdev-status-lib.sh"
#
# Dependencies:
#   - shared-constants.sh (print_error, print_info, safe_grep_count, etc.)
#   - localdev-ports-lib.sh (ensure_ports_file, is_app_registered)
#   - localdev-db-lib.sh (pg_container_running, pg_container_exists,
#     LOCALDEV_PG_CONTAINER, LOCALDEV_PG_PORT, LOCALDEV_PG_USER,
#     LOCALDEV_PG_IMAGE)
#   - localdev-helper.sh exports: CERTS_DIR, CONFD_DIR, PORTS_FILE,
#     LOCALWP_SITES_JSON
#   - _cmd_list_localdev_projects() defined in localdev-helper.sh orchestrator
#
