...
# example parent/phase work using `For #NNN`). Matching drafts also block
# ordinary redispatch because they are durable checkpoints; they are reported
# distinctly and must be continued or escalated rather than mistaken for a
# completed handoff or raced by a competing implementation.
#
