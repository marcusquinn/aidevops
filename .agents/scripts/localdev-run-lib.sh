...
# =============================================================================
# localdev-run-lib.sh -- Zero-config dev server wrapper (cmd_run)
# =============================================================================
...
#
# Usage: source "${SCRIPT_DIR}/localdev-run-lib.sh"
#
# Dependencies:
#   - shared-constants.sh (print_error, print_info, etc.)
#   - localdev-init-lib.sh (infer_project_name)
#   - localdev-ports-lib.sh (is_app_registered, get_app_port)
#   - localdev-branch-lib.sh (sanitise_branch_name, is_branch_registered,
#     get_branch_port, cmd_branch)
#
