...
# =============================================================================
# localdev-branch-lib.sh -- Branch subdomain routing and management
# =============================================================================
...
# Also contains the cmd_rm (remove app) command.
#
# Usage: source "${SCRIPT_DIR}/localdev-branch-lib.sh"
#
# Dependencies:
#   - shared-constants.sh (print_error, print_info, etc.)
#   - localdev-ports-lib.sh (PORT_RANGE_START/END, is_app/port/branch_registered,
#     get_branch_port, assign_port, register_branch, deregister_branch,
#     deregister_app, read_ports_registry)
#   - localdev-routes-lib.sh (remove_traefik_route, remove_cert, remove_hosts_entry)
#   - localdev-helper.sh exports: CONFD_DIR, CERTS_DIR, PORTS_FILE
#
