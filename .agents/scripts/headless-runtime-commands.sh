...
cmd_select() {
	...
	# When a tier is specified, resolve the first healthy concrete model for that
	# tier and use it as the explicit model override. This keeps ordered fallback
	# within the requested canonical tier rather than defaulting to standard.
