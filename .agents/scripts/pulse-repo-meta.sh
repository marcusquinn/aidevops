...
#   - repo_allows_pulse_write_actions (t3219)
...
# Contributor repos are intentionally read-only/noise-free: session/memory
# mining is allowed, but merge/stuck/dirty/reconcile scanners must not post,
# label, close, rebase, dispatch, or file maintainer-facing issues.
# Arguments:
#   $1 - repo slug (owner/repo)
