...
#
# Split from a monolithic 2974-line file into sub-libraries (GH#21411).
# Sub-libraries: localdev-init-lib.sh, localdev-ports-lib.sh,
#   localdev-routes-lib.sh, localdev-branch-lib.sh, localdev-run-lib.sh,
#   localdev-db-lib.sh, localdev-status-lib.sh
...
# Sub-library sources
# =============================================================================
# shellcheck source=./localdev-init-lib.sh
# shellcheck disable=SC1091  # sub-library resolved at runtime via $SCRIPT_DIR
source "${SCRIPT_DIR}/localdev-init-lib.sh"

# shellcheck source=./localdev-ports-lib.sh
# shellcheck disable=SC1091  # sub-library resolved at runtime via $SCRIPT_DIR
source "${SCRIPT_DIR}/localdev-ports-lib.sh"

# shellcheck source=./localdev-routes-lib.sh
# shellcheck disable=SC1091  # sub-library resolved at runtime via $SCRIPT_DIR
source "${SCRIPT_DIR}/localdev-routes-lib.sh"

# shellcheck source=./localdev-branch-lib.sh
# shellcheck disable=SC1091  # sub-library resolved at runtime via $SCRIPT_DIR
source "${SCRIPT_DIR}/localdev-branch-lib.sh"

# shellcheck source=./localdev-run-lib.sh
# shellcheck disable=SC1091  # sub-library resolved at runtime via $SCRIPT_DIR
source "${SCRIPT_DIR}/localdev-run-lib.sh"

# shellcheck source=./localdev-db-lib.sh
# shellcheck disable=SC1091  # sub-library resolved at runtime via $SCRIPT_DIR
source "${SCRIPT_DIR}/localdev-db-lib.sh"

# shellcheck source=./localdev-status-lib.sh
# shellcheck disable=SC1091  # sub-library resolved at runtime via $SCRIPT_DIR
source "${SCRIPT_DIR}/localdev-status-lib.sh"

# =============================================================================
# Add Command
# =============================================================================
# NOTE: cmd_add() stays here (105 lines) to preserve its (file, fname)
# identity key in the function-complexity scanner baseline (GH#21411).
...
# =============================================================================
# List Command — localdev projects section
# =============================================================================
# NOTE: _cmd_list_localdev_projects() stays here (101 lines) to preserve its
# (file, fname) identity key in the function-complexity scanner baseline (GH#21411).
