...
#
# This is the LARGEST single extraction in the plan — 29 functions covering
...
# to dispatch-core + orchestrator), so extracting as one module preserves
# locality.
#
...
# byte-identical to their pre-extraction form. Simplification deferred to
# Phase 12 as a separate PR after the full decomposition lands.
