...
# =============================================================================
# Email Health Check -- Infrastructure DNS Checks
# =============================================================================
# DNS-based email authentication and deliverability checks:
# SPF, DKIM, DMARC, MX records, blacklist status,
# BIMI, MTA-STS, TLS-RPT, DANE, and reverse DNS.
#
# Usage: source "${SCRIPT_DIR}/email-health-check-helper-infrastructure.sh"
#
# Dependencies:
#   - shared-constants.sh (print_error, print_info, print_success, print_warning, safe_grep_count)
#   - email-health-check-helper.sh (add_score, print_header, command_exists, DKIM_SELECTORS)
#
...
# Include guard
[[ -n "${_EMAIL_HEALTH_INFRASTRUCTURE_LIB_LOADED:-}" ]] && return 0
_EMAIL_HEALTH_INFRASTRUCTURE_LIB_LOADED=1
