...
handle_route() {
	...
	local proxy_policy=""
	local offload=""
	local offload_reason=""
	local routine_candidate=""
	local compute_notes=""
	local capture_destination=""
	local max_iterations=""
	local max_tool_calls=""
	local max_token_estimate=""
	local stop_after_repeated_success=""
	local stop_on_permanent_failure=""
	local route_decision_ttl_seconds=""
	local efficiency_policy=""
	local todo_id=""
	local issue_ref=""
	local pr_ref=""
	local capture_ref=""
	local performance_ref=""
	local feedback_ref=""
	local safety_notes=""
