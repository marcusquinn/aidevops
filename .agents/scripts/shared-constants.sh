...
# GH#30957 promoted 1.18.25, GH#31588 promoted 1.18.29, and GH#31909 promoted
# 1.18.31 after the same isolated comparison passed. Keep the complete
...
readonly OPENCODE_PINNED_VERSION="1.18.31"
...
readonly OPENCODE_PIN_LAST_CANARY_DATE="2026-09-15"
readonly OPENCODE_PIN_LAST_CANARY_RESULT="pass:1.18.31"
readonly OPENCODE_PIN_REVIEW_DEADLINE="2026-09-22"
readonly OPENCODE_PLUGIN_TESTED_VERSION="1.18.31"
