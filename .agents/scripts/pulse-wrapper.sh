...
AUTO_DECOMPOSER_LAST_RUN="${HOME}/.aidevops/logs/auto-decomposer-last-run"      # t2442
AUTO_DECOMPOSER_INTERVAL="${AUTO_DECOMPOSER_INTERVAL:-86400}"                   # 1 day in seconds (t2442)
...
AUTO_DECOMPOSER_INTERVAL=$(_validate_int AUTO_DECOMPOSER_INTERVAL "$AUTO_DECOMPOSER_INTERVAL" 86400 3600)
