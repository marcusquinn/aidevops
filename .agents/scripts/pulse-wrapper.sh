...
MAX_WORKERS_CAP="${MAX_WORKERS_CAP:-$(config_get "orchestration.max_concurrent_workers" "8")}"          # Hard ceiling regardless of RAM
DAILY_PR_CAP="${DAILY_PR_CAP:-50}"                                                                      # Max PRs created per repo per day (GH#3821)
