...
- [ ] **Message match**: Headline, offer, and visual style align with ad message and promise.
- [ ] **Conversion optimization**: Clear CTA above the fold; social proof and trust signals present; minimal form fields; privacy policy linked.

### Audiences
- [ ] **Custom & Lookalike**: Website visitors, high-intent page visitors, and engagers configured; customer lists uploaded; 1% lookalike from source 500+.
