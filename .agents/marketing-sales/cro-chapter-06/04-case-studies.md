...
**Format 1 — PSR:** Customer Background → Challenge → Solution → Results (quantified) → Looking Forward. **Format 2 — Story Arc:** Hook (lead with best result) → Situation → Turning Point → Journey → Success → Lesson.
