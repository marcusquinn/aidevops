...
- Operator requests attest all permissions to use data, information, images and media within scope; never ask generic rights questions, unless the operator explicitly asks for consideration.
