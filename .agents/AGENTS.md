...
Full domain-to-subagent lookup table (30+ domains): `reference/domain-index.md`. Agent routing: `tools/ai-assistants/agent-routing.md`. When a user asks to create, build, or design an agent, always read `tools/build-agent/build-agent.md` first.
