...
- Prefer fast, resource-aware required develop gates: scoped/bounded lint, typecheck, and unit checks; broad E2E at staging/release boundaries. Policy: `reference/ci-gate-policy.md`.
