...
description: "Report presentation design system inspired by tavily.com."
colors:
  background: "#F6FFFC"
  surface: "#FFFFFF"
  on-surface: "#06251E"
...
# Design System: Tavily AI search

AI search product freshness. This DESIGN.md is a report-presentation brand preset for Markdown-first HTML previews and PDF deliverables.
...
- **Source inspiration**: tavily.com
- **Accent**: `#008A6A` with supporting container `#DDF7EF`
- **Background/surface**: `#F6FFFC` / `#FFFFFF`
- **Text**: `#06251E` primary, `#31524A` secondary
