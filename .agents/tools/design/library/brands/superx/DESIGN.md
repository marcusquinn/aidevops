...
description: "Report presentation design system inspired by superx.so."
colors:
  background: "#F5F7FF"
  surface: "#FFFFFF"
  on-surface: "#111827"
...
analytics SaaS polish. This DESIGN.md is a report-presentation brand preset for Markdown-first HTML previews and PDF deliverables.
...
- **Source inspiration**: superx.so
- **Accent**: `#1D4ED8` with supporting container `#E5ECFF`
- **Background/surface**: `#F5F7FF` / `#FFFFFF`
