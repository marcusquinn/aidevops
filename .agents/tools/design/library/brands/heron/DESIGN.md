...
---
version: alpha
name: "Heron power blueprint"
description: "Report presentation design system inspired by heronpower.com technical blueprint."
colors:
  background: "#F3F7FB"
  surface: "#FFFFFF"
  on-surface: "#0B1F33"
...
# Design System: Heron power blueprint

technical energy blueprint. This DESIGN.md is a report-presentation brand preset for Markdown-first HTML previews and PDF deliverables.
...
- **Source inspiration**: heronpower.com technical blueprint
- **Accent**: `#0369A1` with supporting container `#E0F2FE`
- **Background/surface**: `#F3F7FB` / `#FFFFFF`
- **Text**: `#0B1F33` primary, `#40576D` secondary
