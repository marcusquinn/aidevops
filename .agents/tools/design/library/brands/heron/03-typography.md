...
- `Archivo Variablefont Wdth Wght`
- `Archivo Variablefont Wdth Wght, Arial, sans-serif`
- `Arial, sans-serif`
- `Helvetica Neue, Helvetica, Ubuntu, Segoe UI, Verdana, sans-serif`
- `Intertight Variablefont Wght`
- `Intertight Variablefont Wght, Arial, sans-serif`
- `monospace`
- `sans-serif`
