# Design System: Resend — Layout Principles
...
| Value | Use |
|-------|-----|
| 4px | Buttons (ghost), inputs, small interactive elements |
| 6px | Menu panels, navigation items |
| 8px | Tabs, content blocks |
| 10px | Accent elements |
| 12px | Clipboard buttons, medium containers |
| 16px | Feature cards, images, main buttons |
| 24px | Large panels, section containers |
| 9999px | Primary CTAs, tags, badges (pill) |
