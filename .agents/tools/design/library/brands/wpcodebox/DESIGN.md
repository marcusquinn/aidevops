...
---
version: alpha
name: "WPCodeBox developer"
description: "Report presentation design system inspired by wpcodebox.com."
colors:
  background: "#F7FAFC"
  surface: "#FFFFFF"
  on-surface: "#111827"
...
# Design System: WPCodeBox developer

developer WordPress product styling. This DESIGN.md is a report-presentation brand preset for Markdown-first HTML previews and PDF deliverables.
...
- **Source inspiration**: wpcodebox.com
- **Accent**: `#047857` with supporting container `#DFF7EC`
- **Background/surface**: `#F7FAFC` / `#FFFFFF`
- **Text**: `#111827` primary, `#4A5568` secondary
