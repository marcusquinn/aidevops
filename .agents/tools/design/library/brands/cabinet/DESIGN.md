...
version: alpha
name: "Cabinet docs"
description: "Report presentation design system inspired by docs.runcabinet.com."
colors:
  background: "#F8FAFC"
  surface: "#FFFFFF"
  on-surface: "#111827"
...
# Design System: Cabinet docs

developer docs clarity. This DESIGN.md is a report-presentation brand preset for Markdown-first HTML previews and PDF deliverables.
...
- **Source inspiration**: docs.runcabinet.com
- **Accent**: `#4F46E5` with supporting container `#E0E7FF`
