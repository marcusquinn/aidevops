...
These examples are reviewed, versioned report templates. They demonstrate the
...
```bash
.agents/scripts/report-render-helper.sh render _reports/templates/llm-visibility-toolbox/report.md \
  --template axel \
  --pdf-profile a4 \
  --output _reports/templates/llm-visibility-toolbox/report.html

.agents/scripts/report-render-helper.sh render _reports/templates/client-ai-search-audit/report.md \
  --template ibm \
  --pdf-profile a4 \
  --output _reports/templates/client-ai-search-audit/report.html
```
