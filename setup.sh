...
main() {
    ...
    echo "4. Setup Codacy CLI: export CODACY_API_TOKEN='your_token_here' && bash .agent/scripts/codacy-cli.sh install"
    echo "5. Test access: ./servers-helper.sh list"
    echo "6. Read documentation in docs/ for provider-specific setup"
    echo ""
